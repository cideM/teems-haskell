...
/* package teems-haskell-0.1.0.0 */
#ifndef VERSION_teems_haskell
#define VERSION_teems_haskell "0.1.0.0"
#endif /* VERSION_teems_haskell */
#ifndef MIN_VERSION_teems_haskell
#define MIN_VERSION_teems_haskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_teems_haskell */
...
#define CURRENT_COMPONENT_ID "teems-haskell-0.1.0.0-43MWoOXZItp4K9iZRZ5nt2-teems-haskell"
